...
export const category = () => {
    ...
    const divCat1Aux = document.createElement("div");
    divCat1Aux.classList = "cat-aux";
    ...
    divCat1Aux.appendChild(imgCat1Detaill);
    divCat1Aux.appendChild(aCat1);

    divCat1.appendChild(imgCat1);
    divPCat1.appendChild(pCat1);
    divPCat1.appendChild(divCat1Aux);
    ...
    const divCat2Aux = document.createElement("div");
    divCat2Aux.classList = "cat-aux";
    ...
    divCat2Aux.appendChild(imgCat2Detaill);
    divCat2Aux.appendChild(aCat2);

    divCat2.appendChild(imgCat2);
    divPCat2.appendChild(pCat2);
    divPCat2.appendChild(divCat2Aux);
    ...
    const divCat3Aux = document.createElement("div");
    divCat3Aux.classList = "cat-aux";
    ...
    divCat3Aux.appendChild(imgCat3Detaill);
    divCat3Aux.appendChild(aCat3);

    divCat3.appendChild(imgCat3);
    divPCat3.appendChild(pCat3);
    divPCat3.appendChild(divCat3Aux);
    ...
    const divCat4Aux = document.createElement("div");
    divCat4Aux.classList = "cat-aux";
    ...
    divCat4Aux.appendChild(imgCat4Detaill);
    divCat4Aux.appendChild(aCat4);

    divCat4.appendChild(imgCat4);
    divPCat4.appendChild(pCat4);
    divPCat4.appendChild(divCat4Aux);
